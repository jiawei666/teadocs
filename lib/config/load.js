...
module.exports = function (docsDir, options = {}) {
  ...
  /**
   * 根据docsDir，重新处理文件路径相关的参数
   * @author jiawei666<957089263@qq.com>
   */
  newConfig.nav.tree = path.resolve(docsDir, newConfig.nav.tree)
  newConfig.doc.dir = path.resolve(docsDir, newConfig.doc.dir)
  newConfig.doc.outDir = path.resolve(docsDir, newConfig.doc.outDir)
  newConfig.doc.staticDir = path.resolve(docsDir, newConfig.doc.staticDir)
  newConfig.theme.dir = path.resolve(docsDir, newConfig.theme.dir)
